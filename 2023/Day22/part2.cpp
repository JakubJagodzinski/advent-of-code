...
int simulate_disintegration(vector <struct cube_t> (&cubes));

int count_falls(vector <struct cube_t> cubes);
...
int main() {
    ...
    //display_cubes(cubes);
    cout << "This will take a few minutes (63166 for this input)" << endl;
    int counter = simulate_disintegration(cubes);
    cout << "Total falls: " << counter << endl;
    fclose(fin);
    return 0;
}
