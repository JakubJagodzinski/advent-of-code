...
def mark_antinodes_for_frequency(frequency_locations, antinodes_grid):
    ...
    for first_index in range(0, len(frequency_locations) - 1):
        for second_index in range(first_index + 1, len(frequency_locations)):
            ...
            antinodes_grid[y_first_frequency][x_first_frequency] = '#'
            antinodes_grid[y_second_frequency][x_second_frequency] = '#'
            ...
            if is_primary_diagonal:
                while True:
                    ...
                    if not added:
                        break
                    x_left = x_left_up_antinode
                    y_up = y_left_up_antinode
                    x_right = x_right_down_antinode
                    y_down = y_right_down_antinode
            else:
                while True:
                    added = False
                    ...
                    if not added:
                        break
                    x_right = x_right_up_antinode
                    y_up = y_right_up_antinode
                    x_left = x_left_down_antinode
                    y_down = y_left_down_antinode
